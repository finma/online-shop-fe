  ...
  return (
    <div className=" container grid md:grid-cols-2 min-h-screen">
      <div className="flex justify-center items-center w-full">
        <img src="/img/onlineShopping.svg" alt="illustration" width="400" />
      </div>
      <div className="flex justify-center items-center w-full">
            ...
            <form action="#" autoComplete="off">
              ...
              <div className="flex items-center -mt-4 mb-6">
                <div className="flex ml-auto">
                  <a
                    href="/#"
                    className="inline-flex text-xs sm:text-sm font-thin text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-white"
                  >
                    Lupa Password?
                  </a>
                </div>
