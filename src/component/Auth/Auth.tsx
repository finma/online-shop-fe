            ...
            <div className="inline-block relative text-left">
              <div>
                <button
                  ...
                  type="button"
                  className=" flex justify-center items-center py-2 px-4 w-full text-sm font-medium text-gray-700 dark:text-gray-50 hover:bg-gray-50 dark:hover:bg-gray-500 rounded-md focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 focus:ring-offset-gray-100 focus:outline-none"
                  id="options-menu"
                >
                  <svg
                    width="20"
